...
export const KNOWN_VENDORS: KnownVendor[] = [
  ...
  // ── Meals ────────────────────────────────────────────────
  { name: "Starbucks", category: "Meals", aliases: ["starbucks"] },
  { name: "McDonald's", category: "Meals", aliases: ["mcdonald's", "mcdonalds"] },
  { name: "Chipotle", category: "Meals", aliases: ["chipotle"] },
  { name: "Panera Bread", category: "Meals", aliases: ["panera bread", "panera"] },
  { name: "Dunkin'", category: "Meals", aliases: ["dunkin donuts", "dunkin'", "dunkin"] },
  { name: "DoorDash", category: "Meals", aliases: ["doordash"] },
  { name: "Grubhub", category: "Meals", aliases: ["grubhub"] },
  { name: "Uber Eats", category: "Meals", aliases: ["uber eats", "ubereats"] },
  { name: "Olive Garden", category: "Meals", aliases: ["olive garden"] },
  { name: "Applebee's", category: "Meals", aliases: ["applebee's", "applebees"] },
  { name: "Chili's", category: "Meals", aliases: ["chili's", "chilis"] },
  { name: "Denny's", category: "Meals", aliases: ["denny's", "dennys"] },
  { name: "IHOP", category: "Meals", aliases: ["ihop"] },
  { name: "Subway", category: "Meals", aliases: ["subway"] },
  { name: "Taco Bell", category: "Meals", aliases: ["taco bell"] },
  { name: "Wendy's", category: "Meals", aliases: ["wendy's", "wendys"] },
  { name: "Burger King", category: "Meals", aliases: ["burger king"] },
  { name: "KFC", category: "Meals", aliases: ["kfc"] },
  { name: "Pizza Hut", category: "Meals", aliases: ["pizza hut"] },
  { name: "Domino's", category: "Meals", aliases: ["domino's", "dominos"] },
  {
    name: "Farmer Boys",
    category: "Meals",
